...
export default function SiteHeader() {
  ...
  return (
    <div className="fixed top-0 inset-x-0 z-20 flex items-center justify-between px-6 py-6 md:px-10 md:py-8 bg-gradient-to-b from-background/90 via-background/60 to-transparent">
